// <copyright file="AsyncContentEnvelopeHandlerWithResultAndClass{TContents,THandler,T1,T2,T3,TResult}.cs" company="Endjin Limited">
...
namespace Corvus.ContentHandling.Json.Internal.ContentEnvelopeHandler
{
    ...
    public class AsyncContentEnvelopeHandlerWithResultAndClass<TContents, THandler, T1, T2, T3, TResult> : IAsyncContentHandlerWithResult<ContentEnvelope, T1, T2, T3, TResult>
        where THandler : IAsyncContentHandlerWithResult<TContents, T1, T2, T3, TResult>
    {
        private readonly THandler handler;

        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncContentEnvelopeHandlerWithResultAndClass{TPayload, THandler, T1, T2, T3, TResult}"/> class.
        /// </summary>
