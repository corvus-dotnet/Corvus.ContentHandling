...
Scenario: Serialize a polymorphic content object implementing a common interface
	...
	| SomeValue |
	| Hello     |
	When I serialize the content object called 'item'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithinterface", "someValue": "Hello" }'
...
Scenario: Serialize a polymorphic content object implementing a common interface with a null polymorphic child object
	...
	| Hello     | null  |
	When I serialize the content object called 'item'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithinterfaceandchild", "someValue": "Hello" }'
...
Scenario: Serialize a polymorphic content object implementing a common interface with a polymorphic child object
	...
	| SomeValue | Child   |
	| Hello     | {child} |
	When I serialize the content object called 'parent'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithinterfaceandchild", "someValue": "Hello", "child": { "contentType": "application/vnd.corvus.somecontentwithinterface", "someValue": "Dolly" } }'
...
Scenario: Serialize a polymorphic content object implementing a common interface with a POC child object
	...
	| Hello     | {child} |
	When I serialize the content object called 'parent'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithinterfaceandpocchild", "someValue": "Hello", "child": { "someValue": "Dolly" } }'
...
Scenario: Serialize a polymorphic content object implementing a common abstract base
	...
	| Hello     |
	When I serialize the content object called 'item'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithabstractbase", "someValue": "Hello" }'
...
Scenario: Serialize a polymorphic content object implementing a common abstract base with a null polymorphic child object
	...
	| Hello     | null  |
	When I serialize the content object called 'item'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithabstractbaseandchild", "someValue": "Hello" }'
...
Scenario: Serialize a polymorphic content object implementing a common abstract base with a polymorphic child object
	...
	| Hello     | {child} |
	When I serialize the content object called 'parent'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithabstractbaseandchild", "someValue": "Hello", "child": { "contentType": "application/vnd.corvus.somecontentwithabstractbase", "someValue": "Dolly" } }'
...
Scenario: Serialize a polymorphic content object implementing a common abstract base with a POC child object
	...
	| Hello     | {child} |
	When I serialize the content object called 'parent'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithabstractbaseandpocchild", "someValue": "Hello", "child": { "someValue": "Dolly" } }'
...
Scenario: Serialize a polymorphic content object implementing a common base
	...
	| Hello     |
	When I serialize the content object called 'item'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithbase", "someValue": "Hello" }'
...
Scenario: Serialize a polymorphic content object implementing a common base with a null polymorphic child object
	...
	| Hello     | null  |
	When I serialize the content object called 'item'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithbaseandchild", "someValue": "Hello" }'
...
Scenario: Serialize a polymorphic content object implementing a common base with a polymorphic child object
	...
	| Hello     | {child} |
	When I serialize the content object called 'parent'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithbaseandchild", "someValue": "Hello", "child": { "contentType": "application/vnd.corvus.somecontentwithbase", "someValue": "Dolly" } }'
...
Scenario: Serialize a polymorphic content object implementing a common base with a POC child object
	...
	| Hello     | {child} |
	When I serialize the content object called 'parent'
	Then the serialized result should be a json object '{ "contentType": "application/vnd.corvus.somecontentwithbaseandpocchild", "someValue": "Hello", "child": { "someValue": "Dolly" } }'
...
Scenario: Serialize a poc object with an enum
	...
	When I serialize the content object called 'subject'
	Then the serialized result should be a json object '{ "someValue": "Hello", "someEnum": 2 }'
