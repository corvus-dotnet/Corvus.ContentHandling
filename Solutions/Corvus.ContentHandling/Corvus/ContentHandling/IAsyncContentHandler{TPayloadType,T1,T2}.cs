// <copyright file="IAsyncContentHandler{TPayloadType,T1,T2}.cs" company="Endjin Limited">
...
namespace Corvus.ContentHandling
{
    ...
    public interface IAsyncContentHandler<TPayloadType, T1, T2>
    {
        /// <summary>
        ...
        Task HandleAsync(TPayloadType payload, T1 param1, T2 param2);
    }
}