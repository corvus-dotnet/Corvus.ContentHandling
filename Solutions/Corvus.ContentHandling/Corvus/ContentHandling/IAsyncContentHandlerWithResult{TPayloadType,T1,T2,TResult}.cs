// <copyright file="IAsyncContentHandlerWithResult{TPayloadType,T1,T2,TResult}.cs" company="Endjin Limited">
...
namespace Corvus.ContentHandling
{
    ...
    public interface IAsyncContentHandlerWithResult<TPayloadType, T1, T2, TResult>
    {
        /// <summary>
        ...
        Task<TResult> HandleAsync(TPayloadType payload, T1 param1, T2 param2);
    }
}
