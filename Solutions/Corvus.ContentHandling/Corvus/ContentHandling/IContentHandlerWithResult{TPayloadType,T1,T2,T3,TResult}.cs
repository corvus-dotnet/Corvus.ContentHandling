// <copyright file="IContentHandlerWithResult{TPayloadType,T1,T2,T3,TResult}.cs" company="Endjin Limited">
...
namespace Corvus.ContentHandling
{
    ...
    public interface IContentHandlerWithResult<TPayloadType, T1, T2, T3, TResult>
    {
        /// <summary>
        ...
        TResult Handle(TPayloadType payload, T1 param1, T2 param2, T3 param3);
    }
}