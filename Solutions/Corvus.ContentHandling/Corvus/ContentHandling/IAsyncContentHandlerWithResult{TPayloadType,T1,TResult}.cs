// <copyright file="IAsyncContentHandlerWithResult{TPayloadType,T1,TResult}.cs" company="Endjin Limited">
...
namespace Corvus.ContentHandling
{
    ...
    public interface IAsyncContentHandlerWithResult<TPayloadType, T1, TResult>
    {
        /// <summary>
        ...
        Task<TResult> HandleAsync(TPayloadType payload, T1 param1);
    }
}
