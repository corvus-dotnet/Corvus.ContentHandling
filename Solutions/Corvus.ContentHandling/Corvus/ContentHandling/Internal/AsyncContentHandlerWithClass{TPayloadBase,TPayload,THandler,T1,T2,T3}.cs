// <copyright file="AsyncContentHandlerWithClass{TPayloadBase,TPayload,THandler,T1,T2,T3}.cs" company="Endjin Limited">
...
namespace Corvus.ContentHandling.Internal
{
    ...
    public class AsyncContentHandlerWithClass<TPayloadBase, TPayload, THandler, T1, T2, T3> : IAsyncContentHandler<TPayloadBase, T1, T2, T3>
        where TPayload : TPayloadBase
        where THandler : IAsyncContentHandler<TPayload, T1, T2, T3>
    {
        private readonly THandler handler;

        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncContentHandlerWithClass{TPayloadBase, TPayload, THandler, T1, T2, T3}"/> class.
        /// </summary>
