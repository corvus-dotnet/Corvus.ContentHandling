// <copyright file="AsyncContentHandlerWithResultAndClass{TPayloadBase,TPayload,THandler,T1,TResult}.cs" company="Endjin Limited">
...
namespace Corvus.ContentHandling.Internal
{
    ...
    public class AsyncContentHandlerWithResultAndClass<TPayloadBase, TPayload, THandler, T1, TResult> : IAsyncContentHandlerWithResult<TPayloadBase, T1, TResult>
        where TPayload : TPayloadBase
        where THandler : IAsyncContentHandlerWithResult<TPayload, T1, TResult>
    {
        private readonly THandler handler;

        /// <summary>
        /// Initializes a new instance of the <see cref="AsyncContentHandlerWithResultAndClass{TPayloadBase, TPayload, THandler, T1, TResult}"/> class.
        /// </summary>
