...
{{
    ...
    {{
        ...
        private static readonly ConcurrentDictionary<(string handlerClass, string contentType), Type> CompilationCache = new ConcurrentDictionary<(string handlerClass, string contentType), Type>();
