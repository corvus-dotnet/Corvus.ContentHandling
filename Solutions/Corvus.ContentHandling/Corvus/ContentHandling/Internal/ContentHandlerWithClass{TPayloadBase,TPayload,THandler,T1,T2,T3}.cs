// <copyright file="ContentHandlerWithClass{TPayloadBase,TPayload,THandler,T1,T2,T3}.cs" company="Endjin Limited">
...
namespace Corvus.ContentHandling.Internal
{
    ...
    public class ContentHandlerWithClass<TPayloadBase, TPayload, THandler, T1, T2, T3> : IContentHandler<TPayloadBase, T1, T2, T3>
        where TPayload : TPayloadBase
        where THandler : IContentHandler<TPayload, T1, T2, T3>
    {
        private readonly THandler handler;

        /// <summary>
        /// Initializes a new instance of the <see cref="ContentHandlerWithClass{TPayloadBase, TPayload, THandler, T1, T2, T3}"/> class.
        /// </summary>
        ...
        {
            this.handler.Handle((TPayload)payload, parameter1, parameter2, parameter3);
        }
    }
}