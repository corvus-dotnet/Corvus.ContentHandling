<#
This build process uses the 'ZeroFailed.Build.DotNet' extension
...
#
$SolutionToBuild = (Resolve-Path (Join-Path $here ".\Solutions\Corvus.ContentHandling.slnx")).Path
$ProjectsToPublish = @()
$NuSpecFilesToPackage = @()
$NugetPublishSource = property ZF_NUGET_PUBLISH_SOURCE "$here/_local-nuget-feed"
$IncludeAssembliesInCodeCoverage = "Corvus.ContentHandling*"
